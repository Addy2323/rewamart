...
async function main() {
    ...
    const products = [
        ...
        },
        {
            ...
            price: 3500000,
            image: 'https://placehold.co/400x400/png?text=iPhone+15+Pro+Max',
            categoryId: categories[0].id,
            stockCount: 10,
            cashbackRate: 5.0,
        ...
        {
            name: 'iPhone 14',
            description: '128GB, Midnight, Amazing battery life',
            price: 2100000,
        ...
        },
        {
            ...
            description: 'AI Phone, 256GB, Titanium Gray, S Pen included',
            price: 3200000,
            image: 'https://placehold.co/400x400/png?text=Samsung+S24+Ultra',
            categoryId: categories[0].id,
            stockCount: 15,
            cashbackRate: 7.0,
            vendor: 'Samsung TZ',
        ...
        },
        {
            ...
            description: 'Foldable smartphone, 256GB, Mint, Compact design',
            price: 2400000,
            image: 'https://placehold.co/400x400/png?text=Samsung+Z+Flip+5',
            categoryId: categories[0].id,
            stockCount: 8,
            cashbackRate: 8.0,
            vendor: 'Samsung TZ',
