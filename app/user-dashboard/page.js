    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div className="max-w-6xl mx-auto p-4 space-y-6 pb-20">
                ...
                <div className="flex space-x-4 border-b dark:border-gray-700">
                    <button
                        ...
                        className={`pb-2 px-4 font-medium transition-colors ${activeTab === 'dashboard' ? 'border-b-2 border-emerald-600 text-emerald-600' : 'text-gray-500'}`}
                    >
                        Dashboard
                    </button>
                    <button
                        onClick={() => setActiveTab('messages')}
                        className={`pb-2 px-4 font-medium transition-colors ${activeTab === 'messages' ? 'border-b-2 border-emerald-600 text-emerald-600' : 'text-gray-500'}`}
                    >
                        Messages
                    </button>
                </div>
                ...
                {activeTab === 'messages' ? (
                    <div className="space-y-4">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white">Your Conversations</h3>
                        <ChatList
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Chat with vendors</p>
                            </button>
                        </div>
                    </>
                )}
            ...
            <ChatModal
                ...
                vendorName={selectedConversation?.vendor?.name}
