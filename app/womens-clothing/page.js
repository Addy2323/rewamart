...
export default function WomensClothingPage() {
    ...
    const subcategories = [
        ...
        { id: 'tops', name: 'Tops' },
        { id: 'womens suits', name: 'Womens Suits' },
    ...
    useEffect(() => {
        const loadProducts = async () => {
            ...
            const womensProducts = allProducts.filter(p => {
                ...
                return categoryStr.includes('women') ||
                    categoryStr.includes('dress') ||
                    categoryStr.includes('fashion') ||
                    nameStr.includes('women') ||
    ...
    const handleSubcategoryClick = (subcategoryId) => {
        if (subcategoryId === 'all') {
            ...
            router.push(`/womens-clothing?subcategory=${subcategoryId}`);
        }
    };
