...
export const getProductsWithCashback = () => {
    ...
    // Default products with cashback
    ...
    // Vendor products with cashback
    const vendorProductsWithCashback = vendorProducts.map(product => ({
        ...product,
        cashbackRate: product.cashbackRate || Math.round((product.cashback || 0) * 100),
        inStock: product.inStock !== undefined ? product.inStock : true
    }));
    
    return [...defaultProducts, ...vendorProductsWithCashback];
};
...
export const getAllProducts = () => {
    ...
    // Combine default products with vendor products
    ...
    return [...allProducts, ...vendorProductsWithCashback];
};
